              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <ul className="list-disc list-inside flex flex-col gap-3 text-gray-700 mb-6">
                      <li><strong>Care</strong> <br />
                       <p>We prioritize the well-being and happiness of every child.</p></li>
                      <li><strong>Learning</strong>  <br />
                      <p>We believe in the power of play to inspire curiosity and growth.</p></li>
                      <li><strong>Community</strong> <br />
                       <p>We foster a supportive and inclusive environment for all.</p></li>
                      <li><strong>Excellence</strong> <br />
                      <p>
                      We strive for the highest standards in early childhood education.</p></li>
                    </ul>
                  </div>
                  <div>
                    <img
                      src="https://images.pexels.com/photos/8422259/pexels-photo-8422259.jpeg?auto=compress&cs=tinysrgb&w=600"
                      alt="About Us"
